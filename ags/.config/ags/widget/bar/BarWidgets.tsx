...
import {NotificationMenuWindowName} from "../systemMenu/NotificationMenu";
...
export function NotificationMenuButton({css}: { css: string }){
    return <button
    css={css}
    className="iconButton"
    label="󰂜" 
    onClicked={() => {
        App.toggle_window(NotificationMenuWindowName)
    }}/>
}

export function SysTray({css}: { css: string }) {
